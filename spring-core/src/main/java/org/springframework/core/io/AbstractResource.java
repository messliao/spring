...
/**
 * Convenience base class for {@link Resource} implementations(对于Resource接口的实现),
 * pre-implementing typical behavior（实现了典型的行为 --功能）.
 *
 * <p>（存在方法判断文件能否打开）The "exists" method will check whether a File or InputStream can
...
public abstract class AbstractResource implements Resource {
	...
	/**
	 * This implementation builds a URI（统一资源标识符） based on the URL（统一资源定位符，指向资源的指针） returned
	 * by {@link #getURL()}.
	 */
	@Override
	 ...
	 * <p>The default implementation delegates（委托） to {@link #getFile()}.
