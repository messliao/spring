...
public interface ResourceLoader {
	...
	//	• #getResource(String location) 方法，
	//	根据所提供资源的路径 location 返回 Resource 实例，
	//	但是它不确保该 Resource 一定存在，
	...
	// 具体过程我们在分析 DefaultResourceLoader 时做详细说明
	...
	//	对于想要获取 ResourceLoader 使用的 ClassLoader 用户来说，
	//	可以直接调用该方法来获取。在分析 Resource 时，
	//	提到了一个类 ClassPathResource ，
